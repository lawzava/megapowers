...
- Marketplace source: `add` supports a ref (branch or tag), not a commit sha.
  ...
  `codex plugin marketplace add lawzava/megapowers@v0.1.5`, or, for Claude Code,
  add `"ref": "v0.1.5"` to the `extraKnownMarketplaces` source (see
...
integrity). Tags `v0.1.1` through `v0.1.5` exist to pin against.
