...
- Marketplace source: `add` supports a ref (branch or tag), not a commit sha.
  ...
  `codex plugin marketplace add lawzava/megapowers@v0.3.7`, or, for Claude Code,
  add `"ref": "v0.3.7"` to the `extraKnownMarketplaces` source (see
...
integrity). Tags `v0.1.1` through `v0.3.7` are the release pin range once this
