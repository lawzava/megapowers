...
- Marketplace source: `add` supports a ref (branch or tag), not a commit sha.
  ...
  `codex plugin marketplace add lawzava/megapowers@v0.2.0`, or, for Claude Code,
  add `"ref": "v0.2.0"` to the `extraKnownMarketplaces` source (see
...
integrity). Tags `v0.1.1` through `v0.2.0` exist to pin against.
