...
repo). As of 2026-07-19 no name here collides with Google's set (theirs are
domain-specific: `gke-*`, `bigquery-*`, `gemini-api`, `gcloud`, and similar);
check for collisions when adding a skill.
